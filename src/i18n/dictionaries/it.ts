export const it = {
  ...
  event: {
    ...
    labelParticipation: "Partecipazione",
    participationCouplesOnly: "Solo coppie",
    participationWithoutPartner: "In coppia o senza partner",
    observerAllowed: "Ammessi",
    observerNotAllowed: "Non ammessi",
    labelAudience: "A chi è rivolto",
    audienceBottomSwitch: "Bottom e switch",
    labelFormat: "Formato",
    formatConversation: "Incontro di condivisione e chiacchiera",
